...
pull_db_cat
RC=$(qdb "SELECT COUNT(*) FROM bookings WHERE booking_type='hotel' AND item_id='hotel_029' AND user_name='Promo User' AND room_type='Standard Double' AND promo_code='SAVE10' AND status='confirmed';")
[ "$RC" -gt 0 ] && PASS=1
